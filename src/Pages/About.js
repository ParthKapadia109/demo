...
const About = () => {
    return (
        <>
            <section className="d-flex align-items-center bg-black text-light">
                <div className="container mb-5">
                    <div className="row">
                        <div className="col-12 col-lg-5 order-1 order-lg-1 text-capitalize d-flex justify-content-center flex-column ">
                            <img src={about}
                        ...
                        <div className="col-12 col-lg-7 order-2 order-lg-2 text-capitalize justify-content-center p-5">
                            ...
                            <div className='p-1'>
                                <p className="my-3  text-capitalize fs-5 text-center ">
                                    ...
                                    a credit card or a debit card or an ATM Card.<br />
                                    Major advantages of card payments are that it will only be accepted <br />
                                    if the cardholder has sufficient funds in his/her account and safer than<br />
